...
def plot_one_box(x, img, color=None, label=None, line_thickness=10):
    ...
    tl = line_thickness or round(0.002 * (img.shape[0] + img.shape[1]) / 2) + 10  # line/font thickness
    ...
    if label:
        ...
        c2 = c1[0] + t_size[0] + 10, c1[1] + t_size[1] + 20
        cv2.rectangle(img, c1, c2, color, -1, cv2.LINE_AA)  # filled
        cv2.putText(img, label, (c1[0], c1[1] + 30), 0, tl / 3, [225, 255, 255], thickness=tf, lineType=cv2.LINE_AA)
